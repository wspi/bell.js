...
function *index(prefix) {
  ...
  var timestep = configs.webapp.timestep.default;
...
exports = module.exports = {
  serve: function *() {
    ...
    if (configs.webapp.timestep.rules.length > 0) {
      var timestepRulesContent = fs.readFileSync(configs.webapp.timestep.rules);
      timesteps = JSON.parse(timestepRulesContent);
    }
